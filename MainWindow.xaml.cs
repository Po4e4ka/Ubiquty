...
namespace Ubiquty
{
    public partial class MainWindow : Window
    {
        ...
        StreamWriter Log_File = new StreamWriter("Log_File.txt", true);
        ...
        {            
            ...
            try
            {
                ...
                {                    
                    ...
                    Test.SetUp();
                    Test.staon(textbox4.Text, textbox2.Text, textbox3.Text,password, gateway_IP,mask_IP);
                }
                if (radio == true)
                {
                    APTest Test = new APTest();
                    Test.SetUp();
                    Test.AP(textbox1.Text, textbox3.Text, password, gateway_IP, mask_IP);
                }
            ...
            {
                System.Windows.MessageBox.Show("Попробуйте перезапустить программу, убедитесь, что точки в дефолте и запустите процесс " +
